...
data class Order(
    ...
    val status: Int
        get() = when {
            cancelled != null -> R.string.status_canceled
    ...
    val steps: List<Step>
        get() {
            ...
            if (cancelled != null) {
                list.add(Step(R.string.step_cancelled, cancelled, R.drawable.ic_canceled))
                return list
            }
            ...
            if (delivering != null) {
                list.add(Step(R.string.step_delivering, delivering, R.drawable.ic_step_checked))
            } else {
